    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
        <div className="w-full p-6 rounded-lg shadow-md bg-gray-50 bg-clip-padding backdrop-filter">
            <h1 className="text-3xl font-semibold text-center text-gray-500">Login
                <span className="text-violet-500"> Yapper</span>
            </h1>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input type="password" placeholder="Enter password" className="w-full input input-bordered h-10 bg-violet-300 text-gray-500" 
                        value={password}
                        onChange={(e) => setPassword(e.target.value)}
                    />
                </div>

                <Link to="/signup" className="text-sm hover:underline hover:text-violet-500 mt-2 inline-block">
                    {"Don't"} have an account?
                </Link>

                <div>
                    <button className="btn btn-block btn-sm mt-2 bg-violet-700 hover:bg-violet-950" disabled={loading}>
...
//                   <span className="text-blue-500"> Yappr</span>
//               </h1>
